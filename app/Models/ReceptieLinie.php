...
class ReceptieLinie extends Model
{
    ...
    protected function casts(): array { return ['cantitate' => 'decimal:3', 'cost_unitar' => 'decimal:12', 'valoare' => 'decimal:2']; }

    public function receptie() { return $this->belongsTo(Receptie::class); }
    public function facturaLinie() { return $this->belongsTo(FacturaFurnizorLinie::class); }
