...
- Optiunea „Actualizare din aplicatie in local” primeste registrul ales de utilizator si actualizeaza randurile existente dupa `cod_produs`: cod, stoc, denumire EN, cantitate de comandat, greutate, pret fara TVA, cota TVA si denumire RO. Pretul fara TVA din Excel este pretul fara TVA RON din aplicatie impartit la cursul EUR/RON introdus. Formula existenta pentru pretul cu TVA este pastrata. Produsele absente din registru raman nemodificate, iar codurile duplicate din aplicatie sau din registru blocheaza operatia si sunt afisate.
